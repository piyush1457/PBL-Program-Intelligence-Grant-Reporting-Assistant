...
import { LayoutDashboard, Map, FileText, CalendarRange, Sun, Moon, Info, Compass, Menu, X } from 'lucide-react';
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-40 flex items-center justify-center p-2.5 rounded-xl bg-white/90 dark:bg-zinc-900/90 backdrop-blur-md border border-slate-200/80 dark:border-zinc-800/80 text-slate-700 dark:text-zinc-300 shadow-md hover:bg-slate-50 dark:hover:bg-zinc-800 transition-all duration-200 active:scale-95 cursor-pointer"
      >
      ...
      {isOpen && (
        <div 
          ...
          className="lg:hidden fixed inset-0 z-20 bg-slate-950/20 dark:bg-black/40 backdrop-blur-xs transition-opacity duration-300"
        />
      )}
